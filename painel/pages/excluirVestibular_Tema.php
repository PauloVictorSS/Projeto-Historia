...
<div class="box-content">
    ...
    <form action="<?php echo INCLUDE_PATH_PAINEL?>excluirVestibular_Tema" method="POST" id="form-vestib" class="yellow">
...
<div class="box-content">
    ...
    <form action="<?php echo INCLUDE_PATH_PAINEL?>excluirVestibular_Tema" method="POST" id="form-temas" class="blue">
