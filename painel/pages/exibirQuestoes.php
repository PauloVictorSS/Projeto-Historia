...
<div class="box-content area-de-questoes">
    ...
    <form method="POST" action="<?php echo INCLUDE_PATH_PAINEL ?>exibirQuestoes" id="form">
    ...
    <div class="resultados">
        ...
        <?php
            ...
            if($anterior > 1)
                $anterior = INCLUDE_PATH_PAINEL.'exibirQuestoes.'.$anterior;
            else
                $anterior = INCLUDE_PATH_PAINEL.'exibirQuestoes';
    
            $proximo = 	INCLUDE_PATH_PAINEL.'exibirQuestoes.'.$proximo;
            $inicio = 	INCLUDE_PATH_PAINEL.'exibirQuestoes';
