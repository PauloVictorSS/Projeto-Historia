	...
	<body>
		...
		<header class="cabecalho">
			...
			<nav class="menu">
				...
				<ul>
					<li><a href="#">Home</a></li>
					<li><a href="paginas/areadequestoes.php">Área de Questões</a></li>
					<li><a href="paginas/login.php">Área do Usuário</a></li>
					<li><a href="paginas/entraremcontato.php">Entrar em Contato</a></li>
				</ul>
			</nav>
		</header>

		<main>
			<article class="sobrenos" id="sobreosite">
				<br>
